$(function(){
    ...
    const whenItems = ['오늘', '이번 달 안에', '이번 주 안에', '올해 안에', '1년 안에', '크리스마스 전까지', '1월1일 전까지',
        '다음 달 첫 방송에서', '1시간 후에', '다음 방송에서', '방송 끝날 때'];
    ...
    const howItems = ['대중교통을 타고', '패딩 입고', '비니 쓰고', '비닐장갑 끼고', '여름옷을 입고', '만보를 채울때까지'
        ,'마주치는 사람한테 인사하고', '사랑합니다를 외치고', '전화를 걸어서', '슬링백을 추면서',
        ,'세수를 하면서', '손잡고'];
    const whatItems = ['노래하기', '랩하기', '춤추기', '리액션 하기', '웨이브 춤 추기', '룩북 촬영하기',
        ,'먹방 하기', '먹방투어 3곳 하기', '매운돈까스먹기', '매운짬뽕먹기', '원칩 먹기', '라면 먹기', '취두부 먹기'
        ,'롤 하기', '게임 하기', '월드컵 게임하기', '코스프레 하기'
        ,'기부하기', '봉사하기', '야방하기'
        ,'국토대장정하기', '인생네컷 찍기', '왁싱하기', '염색하기', '등산하기', '여행가기', '데이트하기'];
