$(function(){
    ...
    const whereItems = ['집에서', '편의점에서', '바다에서', '한강에서', '서울에서', '경기도에서', '강원도에서', '제주도에서'
    ...
    const whoItems = ['내가', '혼자서', '다른 BJ랑', '아무나 1명이랑', '아무나 3명이랑', '아무나 2명이랑', '가장 최근 전화한 사람이랑',
        ...
        '(bj가 선택한)유저', 'bj가, 아무나'];
    const howItems = ['대중교통을 타고', '패딩 입고', '비니 쓰고', '장갑 끼고',
        '눈을 뒤집으면서', '인사를 하면서', '사랑합니다를 외치면서', '퇴장을 하면서', '전화를 걸어서', '슬링백을 추면서', '동전을 뿌리면서',
        '비둘기를 물리치면서', '깜찍한 표정을 지으면서', '잠에 들면서', '세수를 하면서', '째려보면서', '팔쟝을 끼면서'];
    const whatItems = ['노래하기', '춤추기', '먹방하기', '먹방투어하기', 
        '롤하기', '게임하기', '가장 최신 댓글 읽어주기', '웨이브 춤 추기', '여름 옷 입고 있기', '댓글 달기', '라면 먹기', '인생네컷찍기'];
